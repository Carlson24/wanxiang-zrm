...
function M.init(env)
  ...
  local db_name = db_name_val and db_name_val:get_string() or "userdatabase/replacer"
        ...
        if val then
          ...
          for p in s_gmatch(val, split_pat) do
            ...
            if not seen_texts[item_text] then
              ...
              local abbrev_cand = Candidate(final_type, seg and seg.start or 0, seg and seg._end or #input_code,
                item_text, "")
